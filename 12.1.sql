...
INSERT INTO transaction (txn_date, account_id, txn_type_cd, amount, funds_avail_date) VALUES (CURRENT_TIMESTAMP(), @money_account_id, 'CDT', @amount, CURRENT_TIMESTAMP());

INSERT INTO transaction (txn_date, account_id, txn_type_cd, amount, funds_avail_date) VALUES (CURRENT_TIMESTAMP(), @checking_account_id, 'DBT', @amount, CURRENT_TIMESTAMP());
